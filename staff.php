                    ...
                    <section id="members">
                        <section id="our-speakers">
                            ...
                            <div class="author-block course-speaker">
                                ...
                                <article class="paragraph-wrapper">
                                    <div class="inner">
                                        <header><a href="staff-detail.php">Rachel Britain</a></header>
                            ...
                            <div class="author-block course-speaker">
                                <a href="staff-detail.php"><figure class="author-picture"><img src="assets/img/discussion-author-03.jpg" alt=""></figure></a>
                                <article class="paragraph-wrapper">
                                    <div class="inner">
                                        <header><a href="staff-detail.php">John Doe</a></header>
