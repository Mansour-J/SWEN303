                                        ...
                                        <div class="table-responsive">
                                            <table class="my-profile-table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <textarea id="bio">Pattern Recognition, Computer Vision, Evolutionary Algorithms, Artificial Neural Networks</textarea>
                                                        </div><!-- /input-group -->
                                                    </td>
                                                </tr>
                                                <tr>
                            ...
                            <section id="password">
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-md-offset-4">
                                        <p>
                                          Pattern Recognition, Computer Vision, Evolutionary Algorithms, Artificial Neural Networks
                                        </p>
                                        <form role="form" class="clearfix" action="http://www.theme-starz.com/html/Victoria/course-joined.html">
