...
<div class="wrapper">
    ...
    <div id="page-content">
        <div class="container">
            <header><h1>Special Topic: Introduction to Big Data Analysis</h1></header>
            <div class="row">
                <!-- Course Image -->
                <div class="col-md-2">
                            ...
                            <article class="course-detail">
                                ...
                                <section class="course-schedule">
                                    ...
                                    <article class="course-schedule-block course-completed">
                                        ...
                                        <figure class="course-completed-tag"><i class="fa fa-check"></i>Completed
                                        </figure>
                                ...
                                <section id="course-video">
                                    ...
                                    <iframe src="http://player.vimeo.com/video/64373696" width="500" height="281"
...
Writing an essay is an important part of your assessment. The essay helps you to achieve the course objective number one. You will find the essay title and description in essay 2017 guidelines that is accessible from the course home page. The essay is _due on Friday 20 May.  You may find it useful to consult also general essay guidelines. Your essay should not exceed 5000 words. Submit the essay electronically as a .pdf file, and also print it and hand in a hard copy into the hand-in box. There will be no essay presentations this year.
                                ...
                                <section id="sponsors">
                                    ...
                                    <div class="section-content">
                                        <div class="logos">
                                            <div class="logo"><a href="#"><img src="assets/img/logo-partner-01.png"
                                                                               alt=""></a></div>
                                            <div class="logo"><a href="#"><img src="assets/img/logo-partner-02.png"
                                                                               alt=""></a></div>
                                            <div class="logo"><a href="#"><img src="assets/img/logo-partner-03.png"
                                                                               alt=""></a></div>
                                            <div class="logo"><a href="#"><img src="assets/img/logo-partner-04.png"
                                                                               alt=""></a></div>
                                        </div>
                                    </div>
                                </section><!-- /#sponsors -->
                                ...
                                <section id="join-to-course" class="center">
                                    <a href="register-sign-in.html" class="btn" id="btn-course-join-bottom">Join
                                        Course</a>
